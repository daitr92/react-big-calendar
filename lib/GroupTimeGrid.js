...
var _GroupColumn = require('./GroupColumn');

var _GroupColumn2 = _interopRequireDefault(_GroupColumn);
...
var TimeGrid = function (_Component) {
  ...
  TimeGrid.prototype.componentDidUpdate = function componentDidUpdate() {
    ...
    this.applyScroll();
    if (this.props.timeIndicator) this.positionTimeIndicator();
    //this.checkOverflow()
  };
  ...
  TimeGrid.prototype.render = function render() {
    ...
    var _props2 = this.props,
        ...
        timeIndicator = _props2.timeIndicator;
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        timeIndicator && _react2.default.createElement('div', { ref: 'timeIndicator', className: 'rbc-current-time-indicator' }),
  ...
  TimeGrid.prototype.renderEvents = function renderEvents(range) {
    ...
    var date = range[0];
    return groups.map(function (aGroup) {
      return _react2.default.createElement(_GroupColumn2.default, _extends({}, _this3.props, {
        group: aGroup,
        ...
        events: events.filter(function (event) {
          return event.groupId === aGroup.id;
        })
      }));
    });
  };

  TimeGrid.prototype.renderHeader = function renderHeader(range) {
    var _this4 = this;
  ...
  TimeGrid.prototype.positionTimeIndicator = function positionTimeIndicator() {
    ...
    var todayOnView = range.some(function (date) {
      return _dates2.default.isToday(date);
    });
...
TimeGrid.propTypes = {
  ...
  timeIndicator: _propTypes2.default.bool.isRequired,
