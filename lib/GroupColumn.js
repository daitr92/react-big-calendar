...
var GroupSlot = function (_React$Component) {
  _inherits(GroupSlot, _React$Component);

  function GroupSlot() {
    var _temp, _this, _ret;

    _classCallCheck(this, GroupSlot);
  ...
  GroupSlot.prototype.componentDidMount = function componentDidMount() {
    this.props.selectable && this._selectable();
  };

  GroupSlot.prototype.componentWillUnmount = function componentWillUnmount() {
    this._teardownSelectable();
  };

  GroupSlot.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    if (nextProps.selectable && !this.props.selectable) this._selectable();
    if (!nextProps.selectable && this.props.selectable) this._teardownSelectable();
  };

  GroupSlot.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _extends({}, props, {
        className: (0, _classnames2.default)('rbc-day-slot'),
        now: now,
        min: min,
        max: max,
        step: step
...
GroupSlot.defaultProps = { dragThroughEvents: true };
