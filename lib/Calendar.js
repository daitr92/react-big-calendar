...
Calendar.propTypes = {
  ...
  /**
   * Wheather to show time indicator or not.
   *
   * @default true
   */
...
Calendar.defaultProps = {
  ...
  views: [_constants.views.MONTH, _constants.views.WEEK, _constants.views.DAY, _constants.views.GROUP, _constants.views.AGENDA],
  timeIndicator: true,
  date: now,
  step: 30,
